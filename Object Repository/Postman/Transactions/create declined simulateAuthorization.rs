...
<WebServiceRequestEntity>
   ...
   <name>create declined simulateAuthorization</name>
   <tag></tag>
   <elementGuidId>f514b674-b103-400f-83fa-f3080ed21bfd</elementGuidId>
  ...
  &quot;charset&quot;: &quot;UTF-8&quot;
   ...
   <variables>
      <defaultValue>GlobalVariable.beeceptor_declined_transaction</defaultValue>
      <description></description>
      <id>e642d5af-e685-4b29-a52f-a036f092232f</id>
      <masked>false</masked>
      <name>beeceptor_declined_transaction</name>
   </variables>
   <variables>
...
declinedState = jsonResponse.transaction.state
log.logInfo('-----> transaction.state = ' + declinedState)
WS.verifyElementPropertyValue(response, 'transaction.state', 'DECLINED')
declined_response_reason = jsonResponse.transaction.response.memo
log.logInfo('-----> declined_response_reason = ' + declined_response_reason)
