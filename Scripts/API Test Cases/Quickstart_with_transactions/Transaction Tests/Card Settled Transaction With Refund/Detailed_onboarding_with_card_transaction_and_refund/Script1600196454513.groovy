...
String original_transaction_token = CustomKeywords.'detailed_Onboarding.detailed_onboarding.createTransAuth'(card_token, 
    GlobalVariable.trans_amount1, GlobalVariable.mid, GlobalVariable.beeceptor_create_transaction, GlobalVariable.beeceptor_username, 
    GlobalVariable.beeceptor_password)

String advice_transaction_token = CustomKeywords.'detailed_Onboarding.detailed_onboarding.createTransAuthAdvice'(original_transaction_token, 
    GlobalVariable.advice_amount, GlobalVariable.mid, GlobalVariable.beeceptor_create_auth_advice, GlobalVariable.beeceptor_username, 
    GlobalVariable.beeceptor_password)
