...
CustomKeywords.'detailed_Onboarding.detailed_onboarding.createTransFinancialWithdrawal'(card_token, GlobalVariable.trans_amount1, 
    GlobalVariable.mid, GlobalVariable.beeceptor_create_financial_withdrawal, GlobalVariable.beeceptor_username, GlobalVariable.beeceptor_password)

CustomKeywords.'detailed_Onboarding.detailed_onboarding.updateCardProduct'(card_product_token)

String original_transaction_token = CustomKeywords.'detailed_Onboarding.detailed_onboarding.createTransFinancialWithdrawal'(
    card_token, GlobalVariable.trans_amount1, GlobalVariable.mid, GlobalVariable.beeceptor_create_financial_withdrawal, 
    GlobalVariable.beeceptor_username, GlobalVariable.beeceptor_password)

String cleared_transaction_token = CustomKeywords.'detailed_Onboarding.detailed_onboarding.createTransClearing'(original_transaction_token, 
    GlobalVariable.trans_amount1, GlobalVariable.mid, GlobalVariable.force_post, GlobalVariable.beeceptor_settle_transaction, 
    GlobalVariable.beeceptor_username, GlobalVariable.beeceptor_password)

CustomKeywords.'detailed_Onboarding.detailed_onboarding.createTransClearingRefund'(original_transaction_token, GlobalVariable.trans_amount1, 
    GlobalVariable.mid, GlobalVariable.is_refund, GlobalVariable.beeceptor_create_refund, GlobalVariable.beeceptor_username, 
